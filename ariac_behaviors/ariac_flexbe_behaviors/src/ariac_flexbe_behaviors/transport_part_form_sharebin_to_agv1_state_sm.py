...
'''
class transport_part_form_sharebin_to_agv1_stateSM(Behavior):
	'''
	...
	def __init__(self):
		super(transport_part_form_sharebin_to_agv1_stateSM, self).__init__()
		self.name = 'transport_part_form_sharebin_to_agv1_state'
	...
	def create(self):
		...
		_state_machine.userdata.config_name_bin4PreGrasp = 'bin4PreGraspR2'
		_state_machine.userdata.config_name_tray1PreDrop = 'tray1PreDrop'
		_state_machine.userdata.ref_frame = 'arm2_linear_arm_actuator'
		_state_machine.userdata.camera_topic = '/ariac/bin4_camera'
		_state_machine.userdata.camera_frame = 'bin4_camera_frame'
		_state_machine.userdata.tool_link = 'ee_link'
		_state_machine.userdata.agv_pose = []
		_state_machine.userdata.part_offset_pick = 0.025
		...
		with _state_machine:
			...
			OperatableStateMachine.add('pose on agv',
										...
										autonomy={'continue': Autonomy.Off, 'failed': Autonomy.Off},
										remapping={'move_group': 'move_group', 'move_group_prefix': 'move_group_prefix', 'tool_link': 'tool_link', 'part_pose': 'pose_on_agv', 'pose': 'agv_pose', 'offset': 'offset_part', 'rotation': 'rotation', 'joint_values': 'joint_values', 'joint_names': 'joint_names'})
