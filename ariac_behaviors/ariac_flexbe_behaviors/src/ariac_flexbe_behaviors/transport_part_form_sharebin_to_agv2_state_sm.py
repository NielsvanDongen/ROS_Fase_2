...
'''
class transport_part_form_sharebin_to_agv2_stateSM(Behavior):
	'''
	...
	def __init__(self):
		super(transport_part_form_sharebin_to_agv2_stateSM, self).__init__()
		self.name = 'transport_part_form_sharebin_to_agv2_state'
	...
	def create(self):
		...
		_state_machine.userdata.config_name_bin4PreGrasp = 'bin4PreGraspR1'
